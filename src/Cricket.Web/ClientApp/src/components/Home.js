    ...
    render = () => {
        return (
            <div className="text-left">
                <h1>React JS SPA</h1>
                <h5>This is a single-page application built on React with Redux</h5>
                <hr />
                <div className="contents">
                    <Card className="card-expandable">
                        <Card.Header>
                            <span className="card-header-caption">Application features</span>
                        </Card.Header>
                        <Card.Body>
                            This application is built using Microsoft Visual Studio.
                            <br />
